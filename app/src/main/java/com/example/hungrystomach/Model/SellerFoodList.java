...
public class SellerFoodList {
    String name, product_price, url, cooker_uid;
    int quantity;
    double sub_total;
    String random_key;

    public SellerFoodList() {
        //empty
    }

    public SellerFoodList(String name, String product_price, String url, String cooker_uid, int quantity, double sub_total,String random_key) {
        this.name = name;
