...
public class FromNewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contactsView = inflater.inflate(R.layout.fragment_from_new, container, false);

        RecyclerView recycler_view = (RecyclerView) contactsView.findViewById(R.id.recycler_view_2);
